...
This application writes by Visual studio 2013
...
other information about games appear below the table also you could update the goal
then set and winner values will be update depends on goal value.
